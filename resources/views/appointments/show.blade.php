            ...
            @if($appointment->status == 'Cancelada')
                ...
                <div class="alert bg-light text-primary">
                    ...
                    <ul>
                        <li>
                            <strong>
                                Fecha de cancelacion:</strong> {{$appointment->cancellation->create_at}}
                        </li>
                        <li>
                            <strong>
                                La cita fue cancelada por :</strong> {{$appointment->cancellation->cancelled_by->name}}
                        </li>
                        <li>
                            <strong>
                                Motivo de la cancelacion:</strong> {{$appointment->justification}}
                        </li>
                    </ul>
                    @else
                    <ul>
