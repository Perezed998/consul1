          ...
          <div class="card-body">
            ...
            <form action="{{ route('Doctor.store') }}" method="POST" >
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="sanidad" id="sanidad" class="form-control" value="{{old('sanidad')}}">
              ...
              <div class="form-group">
                ...
                <input type="text" name="numcolegio" id="numcolegio" class="form-control" value="{{old('numcolegio')}}">
